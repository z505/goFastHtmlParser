/* Fast HTML parser converted to Go. Originally by James Azarja for fpc.
   This works but is not finished yet, as just a simple conversion from freepascal
   was done. Not correctly go formatted, not aesthetically in best shape.
   Needs polishing and cleaning up. */
